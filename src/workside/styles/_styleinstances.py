...
_hoverButtonData = dict(
  fillColor=QColor(0, 0, 127, 255, ),
  fillStyle=Qt.BrushStyle.SolidPattern,
  lineColor=QColor(191, 95, 0, 255),
  lineStyle=Qt.PenStyle.SolidLine,
  lineWidth=1,
  fontFamily=Family.modern,
  fontWeight=QFont.Weight.Normal,
...
_hoverButtonTextData = dict(
  fillColor=QColor(0, 0, 0, 255, ),
  fillStyle=Qt.BrushStyle.SolidPattern,
  lineColor=QColor(255, 127, 0, 255),
  lineStyle=Qt.PenStyle.SolidLine,
  lineWidth=1,
  fontFamily=Family.modern,
  fontWeight=QFont.Weight.Normal,
...
_baseButton = dict(
  fillColor=QColor(127, 255, 0, 255, ),
  fillStyle=Qt.BrushStyle.SolidPattern,
  lineColor=QColor(127, 63, 0, 255),
  lineStyle=Qt.PenStyle.SolidLine,
  lineWidth=4,
  fontFamily=Family.courierNew,
  fontWeight=QFont.Weight.Normal,
...
hoverButtonTextStyle = BaseStyle(
  'Hover Button Text Style', _hoverButtonTextData)
hoverButtonStyle = BaseStyle('Hover Button Text Style', _hoverButtonData)
...
baseButtonHoverStyle = BaseStyle('Base Button', _baseButtonHover)
