...
from ._styleinstances import outlineStyle, baseButtonStyle
from ._styleinstances import baseButtonHoverStyle
from ._styleinstances import hoverButtonTextStyle, hoverButtonStyle
